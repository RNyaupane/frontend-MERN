            ...
            <div className="col-4">
              ...
              <div className="">
                <address className='text-white fs-6'>
                  Hno: 277 raatopul, Kathmandu <br />
                  Pincode: 132478
                </address>
                <a href="tel:+977 9840953995" className='mt-3 d-block mb-1 text-white'>
                  +977 9840953995
                </a>
        ...
        <div className="conatiner-xxl">
          <div className="row">
            <div className="col-12">
              <p className='text-center mb-0 text-white'>&copy; {new Date().getFullYear()}; Powered by Roshan Nyaupane</p>
            </div>
          </div>
        </div>
      </footer>
